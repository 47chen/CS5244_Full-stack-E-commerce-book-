...
public class BookDaoJdbc implements BookDao {
    ...
    private static final String FIND_BY_BOOK_ID_SQL =
            "SELECT book_id, title, author, description, price, rating, is_public, is_featured, category_id, imageFile " +
                    "FROM book " +
                    "WHERE book_id = ?";
    ...
    private Book readBook(ResultSet resultSet) throws SQLException {
        ...
        return new Book(bookId, title, author, description, price, rating, isPublic, isFeatured, categoryId, imageFile);
    }
}
